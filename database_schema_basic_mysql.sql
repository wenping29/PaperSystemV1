-- Writing Platform Database Schema - Basic Version
...
-- ============================================
--
-- FileService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_file;Uid=root;Pwd=password;...
--
-- SearchService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_search;Uid=root;Pwd=password;...
--
-- FriendshipService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_friendship;Uid=root;Pwd=password;...
--
-- NotificationService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_notification;Uid=root;Pwd=password;...
--
-- UserService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_user;Uid=root;Pwd=password;...
--
-- WritingService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_writing;Uid=root;Pwd=password;...
--
-- AIService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_ai;Uid=root;Pwd=password;...
--
-- ChatService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_chat;Uid=root;Pwd=password;...
--
-- CommunityService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_community;Uid=root;Pwd=password;...
--
-- PaymentService connection string:
-- Server=localhost;Port=3306;Database=writing_platform_payment;Uid=root;Pwd=password;...
--
-- Note: In production, create dedicated database users with limited permissions.
--