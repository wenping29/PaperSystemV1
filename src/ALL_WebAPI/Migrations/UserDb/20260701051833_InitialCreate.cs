        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowingId = table.Column<long>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WritingCount = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    TwitterUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    GitHubUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    LinkedInUrl = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarUrl", "Bio", "CreatedAt", "Email", "IsDeleted", "LastLoginAt", "Location", "PasswordHash", "Phone", "Role", "Status", "UpdatedAt", "Username", "Website" },
                values: new object[] { 1L, null, null, new DateTime(2026, 7, 1, 5, 18, 32, 646, DateTimeKind.Utc).AddTicks(1541), "admin@writingplatform.com", false, null, null, "AQAAAAIAAYagAAAAENpBpO6J7ROv7LzmGQ7wKHfT4Nl1V8hGjH0yXpYpMk0=", null, "Admin", "Active", new DateTime(2026, 7, 1, 5, 18, 32, 646, DateTimeKind.Utc).AddTicks(1542), "admin", null });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivityLogs_ResourceType_ResourceId",
                table: "UserActivityLogs",
